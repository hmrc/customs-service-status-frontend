...
import uk.gov.hmrc.customsservicestatusfrontend.controllers.PlannedWorkController
...
class PlannedWorkPageSpec extends ControllerBaseSpec {
  ...
  "PlannedWorkPage" should {
    "show planned work page as expected with the corresponding content from db" in {
    ...
    "redirect to the landing page" when {
      "the Return to check GVMS availability page link is clicked" in {
